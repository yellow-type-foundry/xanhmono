...
fontmake -g /Users/gabriel/Documents/Glyphs/XanhMonoItalic.glyphs  -i -o ttf --output-dir /Users/gabriel/Documents/fonts/ttf

echo ".
GENERATING STATIC OTF
."
mkdir -p /Users/gabriel/Documents/fonts
fontmake -g /Users/gabriel/Documents/Glyphs/XanhMonoItalic.glyphs  -i -o otf --output-dir /Users/gabriel/Documents/fonts/otf
...
POST-PROCESSING TTF
."
ttfs=$(ls /Users/gabriel/Documents/fonts/ttf/XanhMono-Italic.ttf)
echo XanhMono-Italic.ttf
for ttf in $ttfs
do
...
POST-PROCESSING OTF
."
otfs=$(ls /Users/gabriel/Documents/fonts/otf/XanhMono-Italic.otf)
for otf in $otfs
do
...
woffs=$(ls /Users/gabriel/Documents/fonts/ttf/XanhMono-Italic.woff*)
for woff in $woffs
do
